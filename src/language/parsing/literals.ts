...
export const closingBraceWithBar = literal('|}')
export const closingBracket = literal(']')
...
export const openingBraceWithBar = literal('{|')
export const openingBracket = literal('[')
